...
<FAQBlock
  title="Coffee Grinder FAQ"
  questions={[
    {
      question: "What's the difference between burr and blade grinders?",
      answer: "Burr grinders crush beans between two revolving abrasive surfaces, creating uniform particle sizes. Blade grinders chop beans with spinning blades, resulting in inconsistent sizes that can lead to over or under-extraction."
    },
    {
      question: "How often should I clean my coffee grinder?",
      answer: "Clean your grinder weekly for daily use. Remove old grounds, wipe down surfaces, and deep clean burrs monthly. Some grinders have removable burrs that make cleaning easier."
    },
    {
      question: "Can I use the same grind setting for all brewing methods?",
      answer: "No, different brewing methods require different grind sizes. Espresso needs fine grounds, pour over uses medium-fine, French press requires coarse, and cold brew works best with extra coarse grinds."
    },
    {
      question: "Are expensive grinders worth the investment?",
      answer: "Quality grinders last longer, produce more consistent results, and significantly improve your coffee's taste. A good grinder is often more important than an expensive coffee machine."
    },
    {
      question: "How much should I spend on a coffee grinder?",
      answer: "Budget at least $150-200 for a decent burr grinder. This investment will dramatically improve your coffee quality compared to blade grinders under $50."
    }
  ]}
/>